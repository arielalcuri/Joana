...
const services: Service[] = [
  ...
  {
    id: 'marketplace-genetica',
    icon: <Database className="w-8 h-8" />,
    title: 'Marketplace de Genética',
    subtitle: 'Trazabilidad Blockchain (NFT)',
    description: 'Plataforma de comercialización de semen y embriones con historia clínica y genealógica inalterable.',
    features: [
      'Certificación de Libre de Enfermedades',
      'Pruebas de Eficiencia (RFI)',
      'Pasaporte Digital & Huella Carbono',
      'Diseño de Rodeos Estratégicos',
    ],
