...
export function TraceabilityCertificate({ data, onClose }: CertificateProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-xl animate-in fade-in duration-500">
            ...
            <div className="relative w-full max-w-4xl bg-zinc-950 border-2 border-gold/30 rounded-[2rem] overflow-hidden shadow-[0_0_100px_rgba(212,175,55,0.15)] animate-in zoom-in-95 duration-500">
                <div ref={certificateRef} className="relative bg-zinc-950">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.03] pointer-events-none">
                        <Award className="w-[500px] h-[500px] text-gold" />
                    </div>
                    ...
                    <div className="relative p-12 md:p-16 flex flex-col items-center">
                        ...
                        <div className="text-center mb-16">
                            <h1 className="text-4xl md:text-5xl font-serif text-white mb-4">Certificado de Trazabilidad Inmutable</h1>
                            <div className="h-1 w-32 bg-gradient-to-r from-transparent via-gold to-transparent mx-auto" />
                            <p className="mt-6 text-gray-400 max-w-xl mx-auto italic text-sm md:text-base">
                        ...
                        <div className="w-full grid md:grid-cols-2 gap-12 mb-16">
                        ...
                        <div className="w-full flex justify-between items-end gap-8">
                            <div className="flex-1 border-t border-gray-800 pt-4 text-center">
                            ...
                            <div className="flex flex-col items-center gap-4">
                                <div className="w-20 h-20 border-2 border-gold/20 rounded-full flex items-center justify-center p-2 bg-white">
                                    <img
                ...
                {/* Action Bar */}
                <div className="bg-zinc-900/80 p-6 flex justify-between items-center border-t border-white/5 backdrop-blur-md">
                    <button
                        onClick={onClose}
                    ...
                    <div className="flex gap-4">
                        <Button
                            variant="secondary"
                            className="bg-zinc-800 text-gold border-gold/20 hover:bg-zinc-700 text-xs gap-2"
                            onClick={() => {
                                const receipt = {
                                    hash: data.hash,
                                    timestamp: data.date,
